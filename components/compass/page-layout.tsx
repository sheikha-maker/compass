  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <nav
        ...
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-72 flex-col overflow-y-auto border-r border-sidebar-border bg-sidebar transition-transform duration-200 lg:translate-x-0",
      ...
      >
        ...
        <div className="flex items-center gap-2 border-b border-sidebar-border px-5 py-4">
          ...
          <div>
            <p className="font-serif text-base font-semibold leading-tight text-foreground">The Pre-Med Compass</p>
              ...
              <li key={item.id}>
                ...
                >
                  ...
                  {item.progress && item.progress.total > 0 && (
                    <div className="mt-1.5 h-0.5 overflow-hidden rounded-full bg-sidebar-border">
                      <div
                        className={cn(
                          "h-full rounded-full transition-all duration-300",
                          item.progress.done === item.progress.total ? "bg-green-500" : "bg-primary/60",
                        )}
